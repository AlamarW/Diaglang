class DiagReader:
    ...
    def render_divergent_connections(self, connections):
        ...
        source_rendered = self.render_single_shape(source_shape)
        ...
        target_renders = []
        for conn in connections:
            target_rendered = self.render_single_shape(conn["to"])
    ...
    def render_ascii(self, filename):
        ...
        for shape_input in shapes:
            ...
            divergent = self.parse_divergent_connections(shape_input)
            if divergent:
                rendered_divergent = self.render_divergent_connections(divergent)
